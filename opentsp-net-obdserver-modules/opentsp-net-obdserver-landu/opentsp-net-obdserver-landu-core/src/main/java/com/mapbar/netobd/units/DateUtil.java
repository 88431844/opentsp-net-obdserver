...
public class DateUtil {
	...
	public static final String numFormatStr2 = "yyyyMMdd";
	 ...
	 * yyyyMMdd的日期格式化对象
	 */
	public static final FastDateFormat numFormat = FastDateFormat.getInstance(numFormatStr2);
	/**
	...
	/**
	 * 获得当前时间字符串。格式为：yyyyMMdd
	 * 
	 * @return
	 */
	public static String currentDateNum() {
	...
	public static String getStrDate(long time) {
		return numFormat.format(new Date(time));
	}
